var Effect = {
    ...
    function animate(ele,obj,duration,effect,callBack){
        ...
        if(typeof effect =="number"){
            switch (effect){
                case 1:
                    zfEffect = Effect.Elastic.easeOut;
                    break;
                case 2:
                    zfEffect = Effect.zfBounce.easeOut;
                    break;
                case 3:
                    zfEffect = Effect.Back.easeOut
                    break;
                case 4:
                    zfEffect = Effect.Circ.easeInOut;
                    break;
                case 5:
                    zfEffect = Effect.Quint.easeInOut;
                    break;
